...
transform.getFileInformation = function (file_response){
    ...
    transform.download_url = file_response.downloadUrl;
...
transform.searchFiles = function(items_response){
    var self = this;
    var transform = {};
    transform.page_token = items_response.page_token;
    transform.content = items_response.items.filter(function(item){
        return item.mimetype != "application/vnd.google-apps.folder";
    }).map(function(item){
        return self.getFileInformation(item);
    });
